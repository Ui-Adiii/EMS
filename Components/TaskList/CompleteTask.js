...
const CompleteTask = ({ data, formatted }) => {
  return (
    <div className="flex-shrink-0 flex flex-col justify-between p-5 h-full w-[300px] bg-blue-400 rounded-xl">
      ...
      <div className="text-center">
        ...
        <p className="text-sm mt-5 font-medium">{data.description}</p>
      </div>
      <div className="flex justify-center  items-center mt-8">
        <div className="px-5 py-3 text-center bg-green-600 rounded-xl text-sm font-semibold w-full ">
          Completed
        </div>
      </div>
    </div>
